...
public partial class EP_Category_Add : System.Web.UI.Page
{
    ...
    protected void view_category(int index)
    {
        ...
        {
            mySQL = "select * from npi_ep_category where " +
        ...
        {
            mySQL = "select * from npi_ep_category where EP_Cate_Stage='" + category.Cells[1].Text.Trim()  +
        ...
        {
            mySQL = "select * from npi_ep_category where EP_Cate_Stage='" + category.Cells[1].Text.Trim() + "' and " +
